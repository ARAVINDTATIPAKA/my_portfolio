...
import { Reveal, skillsContainerVariants, skillsItemVariants, processContainerVariants, processItemVariants } from '@/components/Reveal'
...
export default function About() {
  ...
  return (
    <section id="about" ref={revealRef} className="about-section" style={{ padding: '96px 0', background: sectionBg, borderTop: `1px solid ${border}`, borderBottom: `1px solid ${border}` }}>
      {/* 12-col grid */}
      <div className="about-grid">
        ...
        <div className="about-left">
          ...
          <Reveal variant="blur-in" delay={0.24}>
