...
const PROJECTS = [
  ...
  },
  {
    ...
    desc: 'Decomposed five rigid interview-prep services into 11 atomic capabilities, enabling same-day B2B custom service configuration and collapsing a 900-entry pricing matrix to 6 price points.',
    tags: ['Platform Architecture', 'B2B Admin UX', 'Pricing System', 'InterviewBuddy'],
    year: '3 Months · Shipped',
    bgStyle: 'linear-gradient(135deg,#0d1f1a 0%,#071510 100%)',
    bgText: 'MC',
    caseKey: 'mcsf',
    mvp: false,
    nda: true,
